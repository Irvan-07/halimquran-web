// Indonesia's 38 provinces (current official count, incl. the 2022-2023
// Papua splits) with their real kabupaten/kota lists — standard public
// administrative data (BPS/Kemendagri), not business-specific. Used by
// LocationPicker to match halimquran.com's real "Pilih Area" flow
// (Provinsi -> Kota, confirmed by testing the live PDP directly), not a
...
export const indonesiaRegions: Province[] = [
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Tanjung Jabung Timur", "Kab. Tebo", "Kota Jambi", "Kota Sungai Penuh",
    ],
  },
  {
    name: "Jawa Barat",
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Bondowoso", "Kab. Situbondo", "Kab. Gresik", "Kab. Jember",
      ...
      "Kab. Pasuruan", "Kab. Ponorogo", "Kab. Probolinggo", "Kab. Sampang",
      "Kab. Sidoarjo", "Kab. Sumenep", "Kab. Trenggalek", "Kab. Tuban",
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Natuna", "Kota Batam", "Kota Tanjung Pinang",
    ],
  },
  {
    name: "Lampung",
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Pegunungan Bintang", "Kab. Puncak Jaya", "Kab. Tolikara", "Kab. Yalimo",
      "Kab. Yahukimo",
    ],
  },
  {
    name: "Papua Selatan",
    cities: ["Kab. Asmat", "Kab. Boven Digoel", "Kab. Mappi", "Kab. Merauke"],
  },
  {
    name: "Papua Tengah",
    cities: [
      "Kab. Deiyai", "Kab. Dogiyai", "Kab. Intan Jaya", "Kab. Mimika",
      "Kab. Nabire", "Kab. Paniai", "Kab. Puncak", "Kab. Paniai Timur (Waropen Atas)",
    ],
  },
  {
    name: "Riau",
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Muna", "Kab. Muna Barat", "Kab. Wakatobi", "Kota Baubau", "Kota Kendari",
    ],
  },
  {
    name: "Sulawesi Utara",
